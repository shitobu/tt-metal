        ...
        R"doc(
            ...
            Args:
                ...
                seq_subshard_axis (int, optional): other mesh axis subdividing the input query rows.
                    The cos/sin caches remain replicated on this axis and keep the full-SP slab
                    geometry: chunk_local = input sequence length * subshard axis size. Each rank
                    reads its contiguous query window within the original (possibly rotated) slab.
