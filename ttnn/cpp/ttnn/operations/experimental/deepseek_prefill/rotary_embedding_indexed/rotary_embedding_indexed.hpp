...
// replicated there, with the original SP slab size = input rows * subshard axis size. The reader
// derives the original rotated SP offset before adding this rank's query window within the slab.
//
